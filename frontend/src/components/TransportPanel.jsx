...
export default function TransportPanel({ transportData, prefersReduced }) {
  const getStatusBadgeColor = (status) => {
    ...
    if (s === 'delayed') return 'bg-amber-500/10 text-amber-450 border border-amber-500/25';
    if (s === 'suspended') return 'bg-rose-500/10 text-rose-450 border border-rose-500/25';
    return 'bg-teal-500/10 text-teal-400 border border-teal-500/20'; // World cup teal
  };
  ...
  return (
    <div className="h-full flex flex-col justify-between">
      <div>
        <h2 className="text-[10px] font-black tracking-widest text-slate-400 mb-3.5 flex items-center gap-2 uppercase font-mono">
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <div>
                  ...
                  <span className="text-[9px] text-slate-400 font-mono block">ID: {route.route_id}</span>
                </div>
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-[9px] items-center">
                  <span className="text-slate-400 font-medium font-sans">Passenger Load</span>
              ...
              <div className="flex justify-between items-center text-[10px] mt-2 pt-1.5 border-t border-white/[0.03]">
                <span className="text-slate-400 font-sans">Wait Time</span>
                <span className="font-bold text-slate-300 flex items-center gap-1 font-mono">
